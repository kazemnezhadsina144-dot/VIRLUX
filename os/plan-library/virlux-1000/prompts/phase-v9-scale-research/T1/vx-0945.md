...
# vx-0945 — Research 1000-prompt pack diff vs global library
...
```
PLAN WITH NO ASF — VIRLUX agent prompt vx-0945. Research 1000-prompt pack diff vs global library (Next sprint. Ship with evidence in PRIORITY.md.). Pre-flight: read os/agents/auto-virlux-delivery/MEMORY.md and INCIDENTS.md. Only edit REGISTRY paths or code; tag docs VIRLUX-AUTO-DELIVERY-YYYYMMDD. Post-flight: npm run agent:self-audit and append AUDIT-LOG.
```
