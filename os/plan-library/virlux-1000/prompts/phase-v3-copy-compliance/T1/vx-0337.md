...
# vx-0337 — Add drift-prevention test for new marketing phrase
...
```
PLAN WITH NO ASF — VIRLUX agent prompt vx-0337. Add drift-prevention test for new marketing phrase (Next sprint. Ship with evidence in PRIORITY.md.). Pre-flight: read os/agents/auto-virlux-delivery/MEMORY.md and INCIDENTS.md. Only edit REGISTRY paths or code; tag docs VIRLUX-AUTO-DELIVERY-YYYYMMDD. Post-flight: npm run agent:self-audit and append AUDIT-LOG.
```
