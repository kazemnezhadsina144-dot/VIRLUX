...
# vx-0729 — Validate demo mode gates real money paths
...
```
PLAN WITH NO ASF — VIRLUX agent prompt vx-0729. Validate demo mode gates real money paths (Next sprint. Ship with evidence in PRIORITY.md.). Pre-flight: read os/agents/auto-virlux-delivery/MEMORY.md and INCIDENTS.md. Only edit REGISTRY paths or code; tag docs VIRLUX-AUTO-DELIVERY-YYYYMMDD. Post-flight: npm run agent:self-audit and append AUDIT-LOG.
```
