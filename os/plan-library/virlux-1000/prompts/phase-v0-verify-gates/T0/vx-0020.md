...
# vx-0020 — Update os/plan-library/VIRLUX-PRIORITY.md evidence row
...
```
PLAN WITH NO ASF — VIRLUX agent prompt vx-0020. Update os/plan-library/VIRLUX-PRIORITY.md evidence row (Do now. Minimal scope. Run verify gate before close.). Pre-flight: read os/agents/auto-virlux-delivery/MEMORY.md and INCIDENTS.md. Only edit REGISTRY paths or code; tag docs VIRLUX-AUTO-DELIVERY-YYYYMMDD. Post-flight: npm run agent:self-audit and append AUDIT-LOG.
```
