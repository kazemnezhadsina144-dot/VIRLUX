...
echo "  [ ] Settings → API → Rotate anon/publishable key → update secrets only"
echo "  [x] PostgREST probe — npm run verify:supabase-security (after VIRLUX_SUPABASE_ANON_KEY set)"
echo ""
echo "DNS (Vercel):"
