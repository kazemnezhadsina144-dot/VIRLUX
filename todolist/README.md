# VIRLUX — Future & Tracking Index

This folder captures **launch blockers**, **dev runbooks**, **UI roadmap**, and **ops notes** from build sessions. Add new items here whenever the agent (or team) surfaces follow-ups — not as code TODOs, but as founder/product tracking.
...
**How to use:** When a session ends with “still required” or “if you want next”, append to the relevant file with date + status (`open` / `in-progress` / `done`).
