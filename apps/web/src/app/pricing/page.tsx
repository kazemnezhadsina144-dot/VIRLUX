...
import { COMPANY, PRICING, COVERAGE } from "@virlux/shared";
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mt-12 glass-panel p-8">
          ...
          <ul className="mt-8 space-y-3 text-sm text-slate-300">
            <li>✓ Interac e-Transfer CAD on-ramp</li>
            <li>✓ Upfront FX quote — no hidden spread</li>
            <li>✓ Team roles & maker-checker approvals</li>
            <li>✓ {COVERAGE.supportedCountries} supported corridors</li>
            <li>✓ Audit trail & compliance workflows</li>
            <li>✓ Gas estimate shown before you send</li>
          </ul>
        ...
        <div className="mt-10 rounded-xl border border-white/[0.06] p-6 text-sm text-slate-400">
          ...
          <p className="mt-2">
            Design partners may receive capped volume pricing for 90 days. See{" "}
